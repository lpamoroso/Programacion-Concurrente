...
TASK BODY PUENTE IS
  ...
  WHILE(TRUE)LOOP
    SELECT
      WHEN ((PESO_AUTOS + PESO_CAMIONETAS + PESO_CAMION + 1) <= 5) AND ((ENTRA_CAMION'COUNT > 0) AND ((PESO_AUTOS + PESO_CAMIONETAS + PESO_CAMION + 3) > 5)) ACCEPT ENTRA_AUTO() IS
        PESO_AUTOS := PESO_AUTOS + 1;
      END ENTRA_AUTO;
    OR
      WHEN ((PESO_AUTOS + PESO_CAMIONETAS + PESO_CAMION + 2) <= 5) AND ((ENTRA_CAMION'COUNT > 0) AND ((PESO_AUTOS + PESO_CAMIONETAS + PESO_CAMION + 3) > 5)) ACCEPT ENTRA_CAMIONETA() IS
